...
proname="staff-evaluation-1.0-SNAPSHOT.zip"
linkname="staff-evaluation-1.0-SNAPSHOT.zip"
...
update_link(){
    ...
    # 将版本号写入文件 example: staff-evaluation-v2.0.11
